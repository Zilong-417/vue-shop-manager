<template>
    <div>
        <div class="card-header">
            <span>{{ title }}</span>
            <svg t="1657002156046" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="1342" width="16" height="16">
                <path
